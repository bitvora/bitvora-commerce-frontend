...
export default function Page({ params }: { params: { id: string } }) {
  ...
  const accordionItems = [
    ...
    ...(billingAddressStats?.nonEmptyFields > 0
      ? [
          {
            label: (
              <div className="w-full justify-start text-start">
            ...
            content: (
              <div className="flex flex-col gap-5 px-2 mb-2 relative">
                ...
                <CustomerDetailsItem label="Postal Code" value={customer?.billing_postal_code} />
      ...
      : []),
    ...(shippingAddressStats?.nonEmptyFields > 0
      ? [
          {
            label: (
              <div className="w-full justify-start text-start">
                <SemiboldBody className="text-light-900">
                  Shipping Address{' '}
                  <span className="text-light-700">
                    {shippingAddressStats?.nonEmptyFields}/{shippingAddressStats?.totalFields}
                  </span>
                </SemiboldBody>
              </div>
            ),
            content: (
              <div className="flex flex-col gap-5 px-2 mb-2 relative">
                ...
                <CustomerDetailsItem label="Postal Code" value={customer?.shipping_postal_code} />
      ...
      <Drawer open onClose={handleClose} direction="right" className="drawer" overlayOpacity={0.9}>
        {loading ? (
          ...
          <div className="h-full w-full relative px-4 md:px-6 py-4 md:py-6 rounded-lg flex flex-col bg-primary-40 gap-8 md:gap-10 overflow-auto">
            ...
            <div className="rounded-lg px-5 lg:px-5 py-5 lg:py-6 bg-primary-150 w-full overflow-auto mb-12">
              <Accordion
