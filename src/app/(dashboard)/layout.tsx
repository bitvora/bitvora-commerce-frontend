...
export default async function Layout({ children }: { children: React.ReactNode }) {
  return (
    <ContextProvider>
      <ServerLayout>
        <div className="w-screen h-screen overflow-hidden bg-primary-50 lg:bg-primary-100 lg:px-6 pt-8 lg:pt-6 xl:pt-8 flex flex-col lg:flex-row gap-1 lg:gap-6 relative">
          <Sidebar />
          <Navbar />
