...
const timeTabs = [
  { label: '1D', value: '1D', fetcher: getDailySales, previousFetcher: getYesterdaySales },
  { label: '1W', value: '1W', fetcher: getLastSevenDaysSales, previousFetcher: getPreviousWeek },
  { label: '1M', value: '1M', fetcher: getLastThirtyDaysSales, previousFetcher: getPreviousMonth },
  {
    label: '6M',
    value: '6M',
    fetcher: getLastSixMonthsSales,
    previousFetcher: getPreviousSixMonths
  },
  { label: '1Y', value: '1Y', fetcher: getLastTwelveMonthsSales, previousFetcher: getPreviousYear }
];

export default function SalesGraph() {
  const [currentTab, setCurrentTab] = useState(timeTabs[0].value);
  ...
  return (
    <div className="bg-primary-50 rounded-lg px-8 py-8 w-full flex items-start justify-between">
      <div className="flex flex-col gap-3 w-[300px] h-full">
        ...
        <SemiboldHeader3 className="text-light-900">${total}</SemiboldHeader3>
        <div className="flex items-center gap-1">
          <div
            ...
            {difference !== 0 && <FontAwesomeIcon icon={faArrowUp} />}
